...
class Materia:
    ...
    def __str__(self):
        if len(self.alunos) <= 0:
            ...
            print("{}".format(self.alunos.nome)) #O unico erro esta aqui aparentemente,
                                                # fiz dessa forma pq o professor utilizou algo assim.
                                                #quero que print 'Luccas 12478 matricula trancada'
            print("Vagas Totais: {} Vagas Livres {}".format(self.vagas, self.vagas - len(self.alunos)))
